...
class Jogo extends Model {
	...
	public static function capa($nomeJogo, $nomePlataforma,$imgini)
	{
		...
		$im = $i->get_images($nomeJogo . " " . $nomePlataforma . " cover",$imgini);
		//echo $i->get_link();
		//var_dump($im);
		return $im;
	}
	...
	{
		$sql = new Sql();
		$results = $sql->select("exec erick.dbo.sp_jogo_salvar :jogo_id, :jogo_nome, :pla_id, :jogo_publisher, :jogo_desenvolvedora, :pro_id, :jogo_capa", array(
